...
L["层数文字设置"] = "Stack Text"
L["在屏幕上显示玩家当前总护盾量，支持显示数值或占总血量百分比。"] = "Displays the player's current total absorb amount on screen, either as a value or as a percentage of max health."
L["点击卡片切换启用/禁用，点击 Settings 打开设置。禁用会立即停用；启用未初始化模块仍需 /reload。"] = "Click a card to enable or disable it. Click Settings to configure it. Disabling stops the module immediately; enabling an uninitialized module still requires /reload."
L["隐藏条体"] = "Hide Bar"
...
L["怪物数量"] = "Enemy Count"
L["直接监控玩家身上的 1217607：虚空变形 Buff。Buff 出现开始计时，Buff 消失立即停表。额外显示本次变身内是否施放过 1221150。结束后停表，不隐藏。"] = "Directly tracks the player's 1217607: Void Transformation buff. The timer starts when the buff appears and stops immediately when it fades. It also shows whether 1221150 was cast during the current transformation. When the effect ends, the timer stops but remains visible."
L["显示次数"] = "Show Count"
L["褪色"] = "Dimmed"
L["次数文字"] = "Count Text"
...
L["Dangerous: cannot be undone. Export a backup in Profile Manager first."] = "Peligroso: no se puede deshacer. Primero exporte una copia de seguridad en Profile Manager."
L["设置中心"] = "Ajustes"
...
L["当位移技能CD时 在屏幕上显示文字提醒|cffff0518目前支持法师/盗贼 其他职业后续更新|r"] = "Muestra una alerta en pantalla cuando las habilidades de movimiento estan en tiempo de reutilizacion.|cffff0518Actualmente es compatible con Mage/Rogue. Mas clases mas tarde.|r"
...
L["[EX] 新增 明智灵药提示 默认开启 可在/EX 酒仙监控内调整或是关闭(此提示下周移除)"] = "|cff00ff00[EX]|r |cffffd100Se agrego nueva alerta de Wise Elixir.|r |cffffffffHabilitado de forma predeterminada. Puedes ajustarlo o desactivarlo en /EX > Brewmaster Stagger Bar.|r |cffaaaaaa(Este aviso se eliminara la proxima semana.)|r"
L["[EX] 新增 明志灵药提示 默认开启 可在 /EX 酒仙监控 内调整或关闭（此提示下周移除）"] = "|cff00ff00[EX]|r |cffffd100Se agrego un nuevo aviso de Elixir de Determinacion.|r |cffffffffHabilitado de forma predeterminada. Puedes ajustarlo o desactivarlo en /EX > Brewmaster Stagger Bar.|r |cffaaaaaa(Este aviso se eliminara la proxima semana.)|r"
L["左"] = "Izquierda"
L["右"] = "Bien"
L["鲜血"] = "Sangre"
L["冰霜"] = "Escarcha"
...
L["尺寸"] = "Tamano"
L["|cff97a393示例: Interface\\AddOns\\ExwindTools\\Textures\\EJ-UI\\EX1.PNG|r"] = "|cff97a393Ejemplo: Interfaz\\AddOns\\ExwindTools\\Textures\\EJ-UI\\EX1.PNG|r"
...
-- patch:1764
L["按 6 个职责槽位选择作者方案；副本页会按当前职责自动写入对应的团本 / 大米方案。"] = "Elija perfiles de autor para los 6 puestos de trabajo; la pagina de la mazmorra escribe automaticamente el perfil de Raid/Mythic+ correspondiente para el rol actual."
-- patch:1765
L["按 6 个职责槽位选择Author Profile；Dungeons页会按当前职责自动写入对应的团本 / Mythic+ Profile。"] = "Elija perfiles de autor para los 6 puestos de trabajo; la pagina de Mazmorras escribe automaticamente el perfil de Raid/Mythic+ correspondiente para el rol actual."
-- patch:1768
...
-- patch:1823
L["仅重置计时条/束状条/倒计时/文字公告的外观样式，不删除法术配置。是否继续？"] = "Solo restablece la apariencia de la barra del temporizador/barra de bollos/cuenta regresiva/texto central y mantiene la configuracion de hechizos. ¿Continuar?"
-- patch:1824
