...
L["显示酒仙武僧的酒池百分比，并支持独立满条上限与阈值变色。"] = "Displays the Brewmaster Stagger percentage, with independent full-scale cap and threshold-based color changes."
L["噬灭变身计时"] = "Devourer Transform Timer"
L["玩家施放指定变身法术后，在屏幕显示持续秒数。"] = "Displays the duration in seconds on screen after the player casts the specified transformation spell."
...
L["ExwindTools 和 EXBoss 是免费项目；赞助不会解锁额外功能，所有人使用同一版本。"] = "ExwindTools and EXBoss are free projects. Donations do not unlock extra features; everyone uses the same version."
...
L["实时显示你的施法序列，支持读条/引导/瞬发/打断等状态可视化。"] = "Displays your cast sequence in real time with cast/channel/instant/interrupt state visualization."
...
L["点击卡片切换启用/禁用，点击 Settings 打开设置。更改后需 /reload 生效。"] = "Click a card to enable/disable. Click Settings to configure. Changes require /reload."
L["全部启用"] = "Enable All"
L["全部禁用"] = "Disable All"
L["禁 用"] = "Disable"
L["启 用"] = "Enable"
L["设 置"] = "Settings"
L["确定要重置 ExwindTools 的所有配置并重载吗？\n|cffff4444此操作不可逆！|r"] = "Reset all ExwindTools settings and reload?\n|cffff4444This cannot be undone!|r"
...
L["模块管理用于启用/禁用功能；各模块配置页使用 Grid 面板实时调整。"] = "Use Modules to enable/disable features. Configure each module via its Grid panel."
...
L["以下操作会直接影响本插件配置。重置后会清空 ExwindTools 数据并自动重载界面。"] = "These actions affect addon settings directly. Reset will wipe ExwindTools data and reload."
...
L["使用建议"] = "Tips"
L["模块管理页用于启用/禁用模块，变更后需 /reload 生效。"] = "Use the Modules page to enable/disable modules. Changes take effect after /reload."
L["进入模块设置页后可使用 Grid 面板调整样式、位置和功能开关。"] = "Inside a module settings page, use the Grid panel to adjust styles, position and feature toggles."
...
L["系统: |cffffd100%s (%s)|r  |  区域: |cffffd100%s|r  |  语言: |cffffd100%s|r"] = "OS: |cffffd100%s (%s)|r  |  Region: |cffffd100%s|r  |  Locale: |cffffd100%s|r"
L["PTR: %s  |  BETA: %s  |  ElvUI: %s"] = "PTR: %s  |  BETA: %s  |  ElvUI: %s"
L["时间: |cffffd100%s|r"] = "Time: |cffffd100%s|r"
L["是"] = "Yes"
L["否"] = "No"
L["【当前状态】"] = "[ Current State ]"
L["职业: |cff00ff00%s|r  |  专精: |cff00ff00%s|r  |  等级: |cffffd100%d|r"] = "Class: |cff00ff00%s|r  |  Spec: |cff00ff00%s|r  |  Level: |cffffd100%d|r"
...
L["主属性: 力: |cffffd100%d|r 敏: |cffffd100%d|r 智: |cffffd100%d|r 耐: |cffffd100%d|r"] = "Primary: STR: |cffffd100%d|r AGI: |cffffd100%d|r INT: |cffffd100%d|r STA: |cffffd100%d|r"
L["二级: 爆: |cffffd100%.2f%%|r 急: |cffffd100%.2f%%|r 精: |cffffd100%.2f%%|r 全: |cffffd100%.2f%%|r"] = "Secondary: Crit: |cffffd100%.2f%%|r Haste: |cffffd100%.2f%%|r Mastery: |cffffd100%.2f%%|r Vers: |cffffd100%.2f%%|r"
L["三级: 吸: |cffffd100%.2f%%|r 闪: |cffffd100%.2f%%|r 速: |cffffd100%.2f%%|r 移速: |cffffd100%d%%|r"] = "Tertiary: Leech: |cffffd100%.2f%%|r Avoid: |cffffd100%.2f%%|r Speed: |cffffd100%.2f%%|r Move: |cffffd100%d%%|r"
L["防御: 护甲: |cffffd100%d|r 躲闪: |cffffd100%.2f%%|r 招架: |cffffd100%.2f%%|r 格挡: |cffffd100%.2f%%|r"] = "Defense: Armor: |cffffd100%d|r Dodge: |cffffd100%.2f%%|r Parry: |cffffd100%.2f%%|r Block: |cffffd100%.2f%%|r"
...
L["显示酒仙武僧当前酒池百分比（酒池值 / 最大生命 * 100），支持独立满条上限与阈值变色。"] = "Shows the Brewmaster Monk stagger percentage (stagger amount / max health * 100), with independent full-bar cap and threshold colors."
L["显示酒仙武僧当前酒池百分比（酒池值 / 最大生命 * 100），并提供独立的满条上限、阈值配色，以及明志灵药冷却监控。"] = "Shows the Brewmaster Monk's current stagger percentage (stagger amount / max health * 100), with independent full-bar scaling, threshold colors, and Elixir of Determination cooldown tracking."
...
L["条体填充上限和阈值颜色分开计算。未命中阈值时，使用下方条体外观中的主色。"] = "Bar fill scaling and threshold colors are calculated independently. When no threshold is met, the primary bar color below is used."
L["阈值(%)"] = "Threshold (%)"
...
L["用于监控 Elixir of Determination 冷却。可单独预览图标、设置就绪表现，并调整整组图标外观。"] = "Monitors the cooldown of Elixir of Determination. You can preview the icon separately, configure its ready-state behavior, and adjust the full icon presentation."
...
L["满条上限 (%)"] = "Full Bar Cap (%)"
L["条的填充上限与变色阈值完全独立。正常颜色使用下方计时条外观里的主色。"] = "Bar fill cap and color thresholds are independent. Normal color uses the primary bar color below."
L["超过(%)"] = "Above (%)"
L["颜色 1"] = "Color 1"
L["颜色 2"] = "Color 2"
L["颜色 3"] = "Color 3"
...
L["冷却完成高亮"] = "Ready Glow"
L["[EX] 新增 明智灵药提示 默认开启 可在/EX 酒仙监控内调整或是关闭(此提示下周移除)"] = "|cff00ff00[EX]|r |cffffd100New Wise Elixir alert added.|r |cffffffffEnabled by default. You can adjust or disable it under /EX > Brewmaster Stagger Bar. |cffaaaaaa(This notice will be removed next week.)|r"
L["[EX] 新增 明志灵药提示 默认开启 可在 /EX 酒仙监控 内调整或关闭（此提示下周移除）"] = "|cff00ff00[EX]|r |cffffd100New Elixir of Determination notice added.|r |cffffffffEnabled by default. You can adjust or disable it under /EX > Brewmaster Stagger Bar. |cffaaaaaa(This notice will be removed next week.)|r"
L["作者:"] = "Author:"
L["左"] = "Left"
L["右"] = "Right"
L["鲜血"] = "Blood"
...
L["此模块提供了一个极度详细的地下城百科，涵盖所有层数下的怪物技能数值。"] = "This module provides a detailed dungeon encyclopedia covering monster spell values at all key levels."
L["立即打开手册"] = "Open Guide Now"
L["数值模拟 (全局同步)"] = "Value Simulation (Shared Globally)"
L["模拟层数"] = "Simulated Level"
L["注：模拟层数与“大秘境伤害计算”模块共享数据。"] = "Note: the simulated level is shared with the Mythic Damage Calculator module."
L["选择图案"] = "Choose Icon"
...
L["仅影响 Exwind 自身本地化文本；部分由游戏 API / 第三方库返回的内容不受影响。切换后建议立即重载界面。"] = "Only Exwind's own localized text is affected. Some text returned by game APIs or third-party libraries will not change. Reloading the UI is recommended after switching."
...
L["计时文字"] = "Timer Text"
L["图标高亮"] = "Icon Glow"
L["监控玩家施放 1217605，并通过 473662 图标变化判断变身开始与结束。结束后停表，不隐藏。"] = "Tracks player cast 1217605 and uses 473662 icon changes to detect transform start and end. The timer stops when the transform ends and remains visible."
L["距离监控"] = "Range Check"
L["实时显示目标距离范围，根据与目标的最小距离自动变色。"] = "Displays the target distance range in real time and changes color based on the minimum distance."
...
L["范围格式需要两个 %d (最小/最大，如%d - %d)，仅最小值格式需要一个 %d+。留空使用默认格式。"] = "Range format requires two %d values (min/max, e.g. %d - %d). Min-only format requires one %d+. Leave blank to use the default."
L["位置设置"] = "Position"
L["距离颜色设置"] = "Distance Colors"
L["根据与目标的距离自动切换文字颜色。每个颜色对应一个距离区间。"] = "Automatically switches text color based on target distance. Each color maps to a distance bracket."
L["< 5 码"] = "< 5 yd"
L[">= 5 码"] = ">= 5 yd"
L[">= 10 码"] = ">= 10 yd"
L[">= 15 码"] = ">= 15 yd"
...
L["当位移技能CD时 在屏幕上显示文字提醒|cffff0518目前支持法师/盗贼 其他职业后续更新|r"] = "Shows an on-screen alert when movement abilities are on cooldown.|cffff0518Currently supports Mage/Rogue. More classes later.|r"
L["显示格式 (用 %t 代表时间)"] = "Display Format (%t = time)"
L["小数点阈值(秒)"] = "Decimal Threshold (sec)"
L["|cff97a393示例: 我没有闪(%t) → 我没有闪(12) 或 我没有闪(3.2)|r"] = "|cff97a393Example: No Blink (%t) -> No Blink (12) or No Blink (3.2)|r"
...
L["播放提示音|cffff2007  (所有读条都会播放 无法根据打断过滤)|r"] = "Play alert sound|cffff2007 (plays on all casts; cannot filter by interruptability)|r"
...
L["|cffafafaf输入路径: (举例) Interface\\AddOns\\Exwind\\sound\\注意打断.mp3|r"] = "|cffafafafPath example: Interface\\AddOns\\Exwind\\sound\\Interrupt.mp3|r"
L["举例:打断CD剩余2秒时会显示左边颜色的条 打断CD好的瞬间会变色"] = "Example: when interrupt cooldown reaches 2s, the bar uses the left color and changes when interrupt becomes ready."
L["焦点测试施法"] = "Focus Test Cast"
L["多单位施法条"] = "Multi Unit Cast Bars"
L["使用独立 HUD 施法条显示玩家、目标与焦点施法。"] = "Display player, target, and focus cast bars with independent HUD bars."
L["使用独立 HUD 施法条显示玩家、目标与焦点施法，并支持不可打断染色。"] = "Display player, target, and focus cast bars with independent HUD bars and uninterruptible coloring."
L["单位设置"] = "Unit Settings"
L["玩家施法条"] = "Player Cast Bar"
L["目标施法条"] = "Target Cast Bar"
L["焦点施法条"] = "Focus Cast Bar"
L["使用独立 HUD 施法条显示玩家普通读条与引导，并可隐藏暴雪原生施法条。"] = "Uses an independent HUD cast bar for the player's casts and channels, and can hide the Blizzard default cast bar."
...
L["尺寸"] = "Size"
L["|cff97a393示例: Interface\\AddOns\\ExwindTools\\Textures\\EJ-UI\\EX1.PNG|r"] = "|cff97a393Example: Interface\\AddOns\\ExwindTools\\Textures\\EJ-UI\\EX1.PNG|r"
...
L["开启后可将施法条组依附于任意 UI 元素。若目标框体不存在，将自动对齐到屏幕中心。"] = "Attach the cast bar group to any UI element. Falls back to screen center if the target frame is missing."
...
L["CD就绪时按角色优先级排序，CD冷却中按剩余时间排序（时间短优先）"] = "When cooldown is ready, sort by role priority. While cooling down, sort by remaining time (shorter first)."
...
L["实时显示你的施法序列。支持读条/引导/瞬发/打断状态可视化。"] = "Displays your cast sequence in real time, including cast/channel/instant/interrupt states."
...
L["显示列表"] = "Show List"
L["清空列表"] = "Clear List"
L["输入法术ID后点击添加/移除按钮。已忽略的法术将不会显示在施法序列中。"] = "Enter a Spell ID, then click Add/Remove. Ignored spells will not appear in the cast sequence."
L["全职业延迟容限 (SpellQueueWindow)"] = "Spell Queue Latency (SpellQueueWindow)"
L["AI模式：容限 = 延迟 + 偏移。固定模式：容限 = 设定值。"] = "AI mode: queue window = latency + offset. Fixed mode: queue window = configured value."
...
L["提示：10层以上已包含 1.2x 的非强韧/残暴基础加成。\n此设置会直接影响 MDT 增强和法术详情页显示的数值。"] = "Note: levels above 10 already include the 1.2x base modifier outside Tyrannical/Fortified.\nThis setting directly affects MDT enhancements and spell detail displays."
L["星星 (1)"] = "Star (1)"
L["圆圈 (2)"] = "Circle (2)"
L["菱形 (3)"] = "Diamond (3)"
L["三角 (4)"] = "Triangle (4)"
...
L["支持法术图标替换 + 一次性真团队标记（按钮写入 MDT 路线）"] = "Supports spell icon replacement plus one-shot real raid markers written into the current MDT route."
...
L["左侧/MDT按钮点击后写入当前路线；不会自动重写，也不负责清除。"] = "Writes into the current route when clicking the left/MDT buttons. It will not auto-overwrite or auto-clear."
...
L["快速切换聊天频道的工具栏，每个频道可自定义显示名称、颜色和指令"] = "A quick chat channel bar with customizable label, color, and command for each channel."
...
L["开启后，鼠标悬停在 PVE 挑战面板的副本图标上时，会显示该副本的详细通关记录、队友专精以及该副本的快捷传送冷却状态。"] = "Shows detailed run history, party specs, and dungeon teleport cooldown when hovering dungeon icons in the PVE challenge panel."
...
L["|cff808080* 以上功能仅在 Beta/PTR 环境生效。一键全学按钮会在专业专精页面显示。|r"] = "|cff808080* These features only work on Beta/PTR. The one-click learn button appears on the profession specialization page.|r"
...
L["全屏沉浸式的战绩分析面板。显示实时评分、称号线差距、国服排名、低保进度等。"] = "A full-screen immersive panel for Mythic+ analysis with live score, title-line gap, CN rank, Great Vault progress, and more."
...
L["EXWIND 大秘境统计 v%s  |  称号数据更新于: %s  |  国服玩家总数:%s  | 数据来源:Raider.io"] = "EXWIND Mythic Dashboard v%s  |  Title data updated: %s  |  CN player count: %s  |  Source: Raider.IO"
...
L["仅监控焦点单位施法，支持施法条和音效独立开关。"] = "Only monitors your focus target's casts, with separate toggles for cast bar and alert sound."
...
L["在屏幕上显示高度自定义的玩家属性（急速、全能、躲闪等）。"] = "Displays highly customizable player stats on screen (Haste, Versatility, Dodge, etc.)."
...
L["汇集各种小型实用功能。|cffff0000注意：更改设置后通常需要重载界面 (/reload) 才能完全生效。|r"] = "A collection of small utility features. |cffff0000Note: changes usually require /reload to fully apply.|r"
...
L["提示：当前是什么职责，就自动使用并编辑对应的团本/大米方案。"] = "Alert: the active role automatically selects and edits the matching Raid / Mythic+ Profiles."
...
L["查看当前语音注册细节（默认仅显示非团本）：副本 > BOSS名称(数量) + eventID(trigger0/1/2)。"] = "Shows current voice registration details (default = non-raid only): Dungeon > Boss Name (count) + eventID(trigger0/1/2)."
L["非团本已注册BOSS: %d  |  非团本事件: %d / 全量: %d  |  触发器事件(0/1/2): %d/%d/%d%s"] = "Non-raid registered bosses: %d  |  Non-raid events: %d / Total: %d  |  Trigger events (0/1/2): %d/%d/%d%s"
L["暂无非团本已注册BOSS"] = "No non-raid registered bosses"
L["团本已过滤: %d"] = "Raid filtered: %d"
L["控制全局显示：仅计时条 / 仅束状条 / 两者都启用 / 两者都隐藏。\n可单独关闭大秘境或团本首领提示；关闭后将整体禁用该场景的 Boss 计时、中央文字、语音与颜色覆盖。\n可选：首领战中自动将战斗音频预警分类音量静音（0），脱战恢复原值。"] = "Controls the global display mode: Timer Bar only / Bun Bar only / both enabled / both hidden.\nYou can disable Mythic+ or Raid boss alerts separately; disabling one scene also disables its boss timers, center text, voice alerts, and color overlays.\nOptional: mute combat audio warning volume to 0 during boss fights and restore it after combat."
...
L["忘忧景久语音包，标签与默认包兼容，可直接替换全局语音。"] = "Wangyou Jingjiu voice pack. Compatible with the default labels and can replace the global voice pack directly."
...
L["4个固定Color方案 + 1个自定义方案 + 最多3个额外方案。BossSkill页可直接选择方案或自定义Color。"] = "4 fixed color schemes + 1 custom scheme + up to 3 extra schemes. The Boss Skill page can select a scheme directly or use a custom color."
L["BossSkill页可选择下列方案；选择“自定义Color”时使用“自定义方案”。勾选Enable的额外方案会出现在Skill页下拉。"] = "The Boss Skill page can use the schemes below. Choosing \"Custom Color\" uses the \"Custom Scheme\". Enabled extra schemes also appear in the Skill page dropdown."
L["坦克方案"] = "Tank Scheme"
...
L["查看当前语音注册细节（Default仅显示非团本）：Dungeon > BOSS名称(数量) + eventID(trigger0/1/2)。"] = "Shows current voice registration details (default = non-raid only): Dungeon > Boss Name (count) + eventID(trigger0/1/2)."
L["当前语音注册状态"] = "Current Voice Registration State"
L["查看当前语音注册细节（Default仅显示非团本）：Dungeons > BOSS名称(数量) + eventID(trigger0/1/2)。"] = "Shows current voice registration details (default = non-raid only): Dungeons > Boss Name (count) + eventID(trigger0/1/2)."
L["非团本已注册BOSS: 0  |  非团本Event: 0 / 全量: 0  |  触发器Event(0/1/2): 0/0/0"] = "Non-raid registered bosses: 0  |  Non-raid events: 0 / Total: 0  |  Trigger events (0/1/2): 0/0/0"
L["暂无None非团本已注册BOSS"] = "No non-raid registered bosses"
L["当前职责: dps"] = "Current role: dps"
L["提示: 当前是什么职责，就自动使用并编辑对应的Raid/Mythic+ Profiles."] = "Alert: the active role automatically selects and edits the matching Raid / Mythic+ Profiles."
L["语音引擎未就绪，无法读取注册状态。"] = "The voice engine is not ready, so the registration state cannot be read."
L["语音 / 配置"] = "Voice / Profiles"
L["语音/配置"] = "Voice / Profiles"
L["左侧选择语音包，右侧按团本 / 大米配置作者方案。"] = "Choose a Voice Pack on the left, then configure Raid / Mythic+ author profiles on the right."
L["左侧选择Voice Pack，右侧按团本 / 大米配置 Author Profile。"] = "Choose a Voice Pack on the left, then configure Raid / Mythic+ Author Profiles on the right."
L["按 6 个职责槽位选择作者方案；副本页会按当前职责自动写入对应的团本 / 大米方案。"] = "Choose author profiles for the 6 role slots; the dungeon page writes the matching Raid / Mythic+ profile automatically for the current role."
L["按 6 个职责槽位选择Author Profile；Dungeons页会按当前职责自动写入对应的团本 / Mythic+ Profile。"] = "Choose author profiles for the 6 role slots; the Dungeons page writes the matching Raid / Mythic+ profile automatically for the current role."
L["6 槽位作者方案已接入，副本页会按当前职责自动写入对应方案。"] = "6 author profile slots are active. The dungeon page automatically writes the matching profile for your current role."
L["语音/配置页面依赖 ExwindTools.UI，当前未就绪。请确认 ExwindCore 已正确加载后重开面板。"] = "The Voice / Profiles page depends on ExwindTools.UI. Make sure ExwindCore loaded correctly, then reopen the panel."
L["官方EXBoss默认语音包"] = "Official EXBoss default voice pack"
L["覆盖常见Boss与Mythic+Voicelabels，标准参考实现。"] = "Covers common boss and Mythic+ voice labels with the standard reference implementation."
L["覆盖常见Boss与Mythic+Voicelabels, 标准参考实现。"] = "Covers common boss and Mythic+ voice labels with the standard reference implementation."
L["标签与默认包兼容，可直接替换全局语音。"] = "Compatible with the default label set and can replace the global voice pack."
L["技能触发时在Screen Center显示Spell Name（淡入 → 停留 → 淡出）。"] = "Displays the Spell Name in the screen center when the skill triggers (fade in → hold → fade out)."
L["中心文本"] = "Center Text"
...
L["监控玩家自身的3个私人光环槽位，支持图标大小、位置、倒计时、音效等配置。"] = "Monitors the player's 3 private aura slots, including icon size, position, countdown and sound settings."
L["监控玩家自身的3个私人光环槽位。开启后进入编辑模式可拖动调整位置。"] = "Monitors the player's 3 private aura slots. Enable it and enter edit mode to drag the position."
...
L["确认清空"] = "Confirm Wipe"
L["仅重置计时条/束状条/倒计时/文字公告的外观样式，不删除法术配置。是否继续？"] = "Only resets the appearance of Timer Bar / Bun Bar / Countdown / Center Text and keeps spell configuration. Continue?"
L["将清空 EXBoss 的通用设置、语音设置、技能设置与时间轴设置，但保留外观样式。\n确认继续？"] = "This clears EXBoss general settings, voice settings, spell settings and timeline settings, while keeping appearance styles.\nContinue?"
L["危险：将清空 EXBoss 的全部设置（包含外观）并重载。此操作不可撤销。\n确认继续？"] = "Danger: this wipes every EXBoss setting, including appearance, and reloads the UI. This cannot be undone.\nContinue?"
L["是否退出编辑模式？"] = "Exit Edit Mode?"
L["覆盖常见Boss与Mythic+Voicelabels, 标准参考实现."] = "Covers common boss and Mythic+ voice labels with the standard reference implementation."
L["左侧Select Voice Pack, 右侧按Raid / Mythic+配置Author Profile."] = "Choose a Voice Pack on the left, then configure Raid / Mythic+ Author Profiles on the right."
L["左侧Select Voice Pack，右侧按Raid / Mythic+配置Author Profile."] = "Choose a Voice Pack on the left, then configure Raid / Mythic+ Author Profiles on the right."
L["按 6 个职责槽位选择Author Profile；Dungeons页会按当前职责自动写入对应的Raid / Mythic+ Profiles."] = "Choose Author Profiles for the 6 role slots; the Dungeons page automatically writes the matching Raid / Mythic+ Profiles for your current role."
L["按 6 个职责槽位选择Author Profile；Dungeons页会按当前职责自动写入对应的Raid / Mythic+ Profile."] = "Choose Author Profiles for the 6 role slots; the Dungeons page automatically writes the matching Raid / Mythic+ Profile for your current role."
...
L["6 槽位Author Profile已接入，Dungeons页会按当前职责自动写入对应Profile."] = "6 Author Profile slots are active. The Dungeons page automatically writes the matching Profile for your current role."
L["6 槽位Author Profile已接入, Dungeons页会按当前职责自动写入对应Profile."] = "6 Author Profile slots are active. The Dungeons page automatically writes the matching Profile for your current role."
L["Alert: 当前是什么职责，就自动使用并编辑对应的Raid/Mythic+ Profiles."] = "Alert: the active role automatically selects and edits the matching Raid / Mythic+ Profiles."
L["备注(可选)"] = "Notes (Optional)"
...
L["按首领查看固定轴Skill在前 3 分钟内的出现节点，便于快速校对Timeline节奏。"] = "Review when fixed-timeline Skills occur during the first 3 minutes of each boss fight to quickly verify Timeline pacing."
...
L["分钟节点："] = "min Nodes:"
L["3分钟节点"] = "3min Nodes"
L["按Boss查看Fixed TimelineSkill在前 3 分钟内的出现节点，便于快速校对Timeline节奏。"] = "Review each boss's Fixed Timeline skills over the first 3 minutes to quickly verify Timeline pacing."
L["按Boss查看Fixed TimelineSkill在前 3 分钟内的出现Nodes，便于快速校对Timeline节奏。"] = "Review each boss's Fixed Timeline skills over the first 3 minutes to quickly verify Timeline pacing."
L["按Boss查看Fixed TimelineSkill在前 3 分钟内的出现Nodes, 便于快速校对Timeline节奏。"] = "Review each boss's Fixed Timeline skills over the first 3 minutes to quickly verify Timeline pacing."
L["按Boss查看Fixed TimelineSkill在前3分钟内的出现Nodes，便于快速校对Timeline节奏。"] = "Review each boss's Fixed Timeline skills over the first 3 minutes to quickly verify Timeline pacing."
...
L["提供三种Reset方式：\n1) Reset Appearance Only\n2) Reset所有配置（不Included外观）\n3) 清除全部Settings（Included外观）"] = "Provides three reset modes:\n1) Reset Appearance Only\n2) Reset All Settings (Keep Appearance)\n3) Wipe Everything (Including Appearance)"
L["推荐先使用\"Reset Appearance Only\"：只ResetTimer Bar/Bun Bar/Countdown/Center Text与Color方案。"] = "Recommended: start with \"Reset Appearance Only\". It only resets Timer Bar / Bun Bar / Countdown / Center Text and Color schemes."
L["\"Reset所有配置（不Included外观）\"会清空General Settings、Voice配置、Skill配置与TimelineSettings，但保留外观。"] = "\"Reset All Settings (Keep Appearance)\" clears General Settings, Voice config, Skill config and Timeline settings, while keeping appearance."
...
L["查看Shows current voice registration details (default = non-raid only): Dungeon > Boss Name (count) + eventID(trigger0/1/2)."] = "Shows current voice registration details (default = non-raid only): Dungeon > Boss Name (count) + eventID(trigger0/1/2)."
L["团本已过滤:"] = "Raid filtered:"
L["（预估）"] = "(Estimated)"
L["（实测）"] = "(Live)"
L["团本"] = "Raid"
